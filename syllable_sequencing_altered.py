...
#script altered so lg is argv1 and le argv2
#also uses argv3 as filename and relative path to save graph
...
with model:
    ...
    nengo.networks.actionselection.Weights.lg = float(argv[1])
    nengo.networks.actionselection.Weights.le = float(argv[2])
